...
import { getCurrentTenant, getClients, getItems } from '../../actions';
    ...
    <div className="min-h-screen bg-neutral-950 text-white font-sans">
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <header className="mb-8">
          <h1 className="text-3xl font-extrabold tracking-tight mb-2">Create Sale Voucher</h1>
          <p className="text-neutral-400">Generate a new transaction and post it instantly to the FBR API.</p>
        </header>

        {tenant && <NewVoucherForm clients={clients} items={items} tenantId={tenant.id} />}
      </main>
    </div>
  );
}
